...
Revision ID: 79af78d099c2
Revises: be5843aa701c
Create Date: 2025-03-09 16:42:16.104259
...
revision: str = '79af78d099c2'
down_revision: Union[str, None] = 'be5843aa701c'
...
def downgrade() -> None:
    ...
    op.execute("DELETE FROM biomaterials")
